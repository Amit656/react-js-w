...
const navigation = [
  ...
  {
    name: 'Location Types', to: '/location-types', local: 'locationType.label', icon: GlobeAltIcon,
  },
  {
    name: 'Locations', to: '/locations', local: 'location.label', icon: MapPinIcon,
  },
];
